...
# list 원소 삭제
dataset.remove(6) #값 6을 삭제
print('6.dataset:',dataset)
dataset.pop(1) # 2번째 값을 삭제
print('6-1.dataset:',dataset)

# map 함수 - 리스트 원소를 지정된 함수로 일괄 처리해주는 함수
...
var1, var2, var3 = input('3개 숫자 입력(띄어쓰기 구분):').split() #split이 있어야 여러개받아옴
